...
(function () {
	...
	if(!isThread) return SCRIPT_URL = document.currentScript? document.currentScript.src : SCRIPT_URL || (function(){var tags=document.getElementsByTagName('script'),tag=tags[tags.length-1];return tag.getAttribute('src', 2); })();
	/* Non-Worker code END */
